...
const TIPS = [
  ...
  "Place TUI settings in {highlight}~/.config/hwcli/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "HWCLI auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "HWCLI auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "HWCLI uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent HWCLI from reading sensitive files",
  "Use {highlight}hwcli run{/highlight} for non-interactive scripting",
  "Use {highlight}hwcli --continue{/highlight} to resume the last session",
  "Use {highlight}hwcli run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}hwcli serve{/highlight} for headless API access",
  "Use {highlight}hwcli run --attach{/highlight} to connect to a running server",
  "Run {highlight}hwcli upgrade{/highlight} to update to the latest version",
  "Run {highlight}hwcli auth list{/highlight} to see all configured providers",
  "Run {highlight}hwcli agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}hwcli github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}hwcli debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with HWCLI for curated, tested models",
