...
export const ProjectApi = HttpApi.make("project")
      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with HWCLI.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that HWCLI is working with.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "HWCLI experimental HttpApi",
      version: "0.0.1",
