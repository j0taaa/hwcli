  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all HWCLI sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific HWCLI session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new HWCLI session for interacting with AI assistants and managing conversations.",
