...
Install a plugin and update the configuration.

```bash
opencode plugin <module>
```

This installs an npm module as a plugin and automatically updates the plugin configuration.
...
For example, to install the Huawei Cloud MaaS plugin:
