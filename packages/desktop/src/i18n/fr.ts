export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de HWCLI a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'hwcli'.",
  ...
  "desktop.menu.help.documentation": "Documentation de HWCLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI HWCLI est manquant. Essayez de réinstaller l'application de bureau.",
