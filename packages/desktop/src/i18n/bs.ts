export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju HWCLI-ja",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} HWCLI-ja je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "HWCLI Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka HWCLI CLI-ja. Pokušaj ponovo instalirati desktop aplikaciju.",
