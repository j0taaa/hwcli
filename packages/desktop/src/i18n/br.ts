export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do HWCLI foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do HWCLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do HWCLI está ausente. Tente reinstalar o aplicativo de desktop.",
