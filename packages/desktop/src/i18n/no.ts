export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av HWCLI er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'hwcli'-kommandoen.",
  ...
  "desktop.menu.help.documentation": "HWCLI Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "HWCLI CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
