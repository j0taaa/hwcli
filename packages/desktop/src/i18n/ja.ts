export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの HWCLI を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "HWCLI のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'hwcli' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "HWCLI ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "HWCLI CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
