export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию HWCLI",
  ...
  "desktop.updater.downloaded.prompt": "Версия HWCLI {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'hwcli'.",
  ...
  "desktop.menu.help.documentation": "Документация HWCLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл HWCLI CLI. Попробуйте переустановить настольное приложение.",
