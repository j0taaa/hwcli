export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von HWCLI wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.menu.help.documentation": "HWCLI-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Das HWCLI CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
