export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} HWCLI. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'hwcli'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja HWCLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego HWCLI CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
