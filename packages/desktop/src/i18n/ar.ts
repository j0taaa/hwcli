export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من HWCLI",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من HWCLI، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق HWCLI",
  ...
  "desktop.cli.error.sidecarMissing": "ملف HWCLI CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
