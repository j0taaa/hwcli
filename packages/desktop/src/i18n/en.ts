export const dict = {
  ...
  "desktop.menu.help.documentation": "HWCLI Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of HWCLI has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'hwcli' command.",
  ...
  "desktop.cli.error.sidecarMissing": "HWCLI CLI binary is missing. Try reinstalling the desktop app.",
