export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de HWCLI. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de HWCLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de HWCLI. Intenta reinstalar la aplicación de escritorio.",
