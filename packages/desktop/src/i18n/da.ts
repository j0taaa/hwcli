export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af HWCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af HWCLI er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'hwcli'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "HWCLI CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
